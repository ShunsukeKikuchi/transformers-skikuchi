...
# Copied from transformers.models.t5.modeling_t5.T5ForSequenceClassification with T5->T5LA,t5->t5la
...
@auto_docstring
# Copied from transformers.models.t5.modeling_t5.T5ForTokenClassification with T5->T5LA,t5->t5la
...
@auto_docstring
# Copied from transformers.models.t5.modeling_t5.T5ForQuestionAnswering with T5->T5LA,t5->t5la
