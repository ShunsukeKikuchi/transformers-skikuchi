...
class T5LAModelIntegrationTests(unittest.TestCase):
    ...
    @slow
    def test_export_t5la_summarization(self):
        ...
        exported_t5la = wrapped_model.export()
        ...
        generated_ids = exported_t5la.generate(prompt_token_ids=input_ids, max_new_tokens=max_cache_length)
